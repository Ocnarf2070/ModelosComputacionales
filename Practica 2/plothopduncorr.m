function plothopduncorr(T,beta,uinit,eta,iters,R)
%plothopd(T,beta,uinit,eta,iters)
%
%PLOTHOPD
%
% This function simulates a 100 neuron Hopfield network by calling
...
%[utrace,vtrace] = simhopd(T,beta,uinit,eta,iters);
...
for i=1:iters
  imagesc(reshape(inv(R)*vtrace(:,i),10,10),[-1 1]);
  axis('square');
  drawnow;
end
